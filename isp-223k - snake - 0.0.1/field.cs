...
namespace isp_223k___snake
{
    internal class Field
    {
        ...
        public void GenerateRandomItems(int dia, Timer timer1)
        {
            GenerateApple(dia);
        ...
        {
            apple.X = r.Next(0, (dia / 10) - 10) * 10;
            apple.Y = r.Next(0, (dia / 10) - 10) * 10;
            apple_spawned += 1;
        }

        public int getAppleSpawned()
        {
